...
let teksbio = `┆⫹⫺ 💌 Nama : Dian
┆⫹⫺ ✉️ Nama RL : HAMBA ALLAH
┆⫹⫺ ♂️ Gender : Pria
┆⫹⫺ 🕋 Agama : Kristen
┆⫹⫺ ⏰ Tanggal lahir : 07 - 08 - 2003
┆⫹⫺ 🎨 Umur : 19
┆⫹⫺ 🧮 Kelas : Pekerja
...
title: `⫹⫺ Oᴛʜᴇʀ ⫹⫺`,
rows: [
{title: "⸙ Kontak", rowId: ".081536907492"},
{title: "⸙ Nomor", rowId: ".085765680162"},
{title: "⸙ Biodata Dian", rowId: ".owner bio"},
{title: "⸙ Biodata Yushino", rowId: ".owner bio2"},
{title: "⸙ Script", rowId: ".https://github.com/Patrickstarrrrrrrr"},
]}, {
title: `⬔ Sᴜᴘᴘᴏʀᴛ Mᴇ ⬔`,
rows: [
...
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: ftroli })
 ...
 conn.send2ButtonImg(m.chat, fs.readFileSync('./media/own.jpg').buffer, teksnomor, `Halo ${tag}\nIᴛᴜ Oᴡɴᴇʀ Kᴜ⫺⫰⫹\n` + botdate, `Sewa Bot`, `.sewa`, 'Menu', `.menu`, ftroli, { contextInfo: { externalAdReply: { showAdAttribution: true,
   ...
   conn.sendButton(m.chat, '┍┈༺ *𝙱𝚒𝚘𝙳𝚊𝚝𝚊 Dian* ༻', teksbio, ppown, [
                ['Sewa Bot', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
          ...
          conn.sendButton(m.chat, '┍┈༺ *𝙱𝚒𝚘𝙳𝚊𝚝𝚊 Yushino* ༻', teksbio2, ppown2, [
                ['Sewa Bot', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
...
handler.help = ['081536907492', 'Dian']
